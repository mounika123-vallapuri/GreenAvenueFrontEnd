            ...
            <form:form class="form-horizontal" method="POST" action="saveUser" modelAttribute="user">
                <fieldset>
                    ...
                    <div class="form-group">
                        <form:label path="username" for="inputUserName" class="col-lg-2 control-label">
                            UserName</form:label>
                        <div class="col-lg-10">
                            <form:input type="text"   path="username" class="form-control" id="inputUserName" placeholder="Username"/>
                    ...
                    <div class="form-group">
                        <form:label  path="email" for="inputEmail" class="col-lg-2 control-label">
                            Email</form:label>
                        <div class="col-lg-10">
                            <form:input type="text"   path="email" class="form-control" id="inputEmail" placeholder="Email"/>
                    ...
                    <div class="form-group">
                        <form:label path="password" for="inputPassword" class="col-lg-2 control-label">
                            Password</form:label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group">
                        <form:label path="contact" for="inputContact" class="col-lg-2 control-label">
                            Contact Number</form:label>
                        <div class="col-lg-10">
                            <form:input type="text"   path="contact" class="form-control" id="inputContact" placeholder="Contact Number"/>
							<td><form:errors path="contact" cssClass="error"/></td>	                     
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <form:label  path="address" for="inputAddress" class="col-lg-2 control-label">
                            Address</form:label>
                        <div class="col-lg-10">
                            <form:input type="text"   path="address" class="form-control" id="inputAddress" placeholder="Address"/>
