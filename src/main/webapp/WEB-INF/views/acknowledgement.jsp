...
<div class="row">
	...
	<c:if test="${not empty error}">
		...
		<tbody>
			...
			<div class="media">
			 <a class="thumbnail pull-left" href=""><img class="media-object" src="/GreenAvenueFrontEnd/myImage/imageDisplay?id=${order.productId}" class="img-thumbnail" width="72px" height="72px"/></a>
